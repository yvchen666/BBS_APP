...
public class DataBean {
    ...
    public static List<DataBean> getTestData() {
        ...
        list.add(new DataBean(R.drawable.image1, "极致简约,梦幻小屋", 3));
        list.add(new DataBean(R.drawable.image1, "超级卖梦人", 3));
        list.add(new DataBean(R.drawable.image1, "夏季新搭配", 1));
        list.add(new DataBean(R.drawable.image1, "绝美风格搭配", 1));
        list.add(new DataBean(R.drawable.image1, "微微一笑 很倾城", 3));
        return list;
    }
    ...
    public static List<DataBean> getTestDataVideo() {
        ...
        list.add(new DataBean(R.drawable.image1, "听风.赏雨", 1));
        list.add(new DataBean(R.drawable.image1, "迪丽热巴.迪力木拉提", 1));
        list.add(new DataBean(R.drawable.image1, "爱美.人间有之", 1));
        list.add(new DataBean(R.drawable.image1, "洋洋洋.气质篇", 1));
        list.add(new DataBean(R.drawable.image1, "生活的态度", 1));
        return list;
    }
